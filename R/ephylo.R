...
#'   \item{left.tip}{An integer vector with the index of every node's leftmost
#'     descendant tip. \code{left.tip[u]} returns the index of node \code{u}'s
#'     leftmost tip.}
#'   \item{right.tip}{An integer vector with the index of every node's rightmost
#'     descendant tip. \code{right.tip[u]} returns the index of node \code{u}'s
#'     rightmost tip.}
#'   \item{next.tip}{An integer vector that maintains a left-to-right visitation
#'     order of tips. \code{next.tip[u]} returns the index of the next tip to
#'     visit after visiting tip \code{u}'s.}
#' }
ephylo = function(phy)
{
